...
//        System.out.println(String.join(", ", d.acquireResource(2).getTasks()));
        System.out.println(String.join(", ", d.resources.get(2).getTasks()));
        d.releaseResource(2);
        d.resources.remove(2);
        d.acquireResource(1).performTask("Task11");
        d.acquireResource(1).performTask("Task12");
        System.out.println(String.join(", ", d.resources.get(1).getTasks()));
        d.releaseResource(1);
        d.resources.remove(1);
    }
}